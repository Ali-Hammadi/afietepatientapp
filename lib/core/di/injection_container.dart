import 'package:afietepatientapp/core/network/dio_factory.dart';
...
import 'package:afietepatientapp/feature/assisments/data/repositories/assisments_repository_impl.dart';
...
import 'package:afietepatientapp/feature/auth/domain/usecase/google_signin_usecase.dart';
import 'package:afietepatientapp/feature/auth/domain/usecase/logout_usecase.dart';
import 'package:afietepatientapp/feature/auth/domain/usecase/reactivate_account_usecase.dart';
...
import 'package:afietepatientapp/feature/auth/domain/usecase/update_profile_info_usecase.dart';

import 'package:afietepatientapp/feature/appoinments/data/datasources/appointments_remote_datasource.dart';
import 'package:afietepatientapp/feature/appoinments/data/repositories/appointments_repository_impl.dart';
...
import 'package:afietepatientapp/feature/chat/data/datasources/chat_mock_datasource.dart';
import 'package:afietepatientapp/feature/chat/data/datasources/chat_remote_datasource.dart';
import 'package:afietepatientapp/feature/chat/data/repositories/chat_repository_impl.dart';
import 'package:afietepatientapp/feature/chat/domain/repositories/chat_repository.dart';
import 'package:afietepatientapp/feature/chat/domain/usecases/get_chat_messages_usecase.dart';
import 'package:afietepatientapp/feature/chat/domain/usecases/mark_chat_message_read_usecase.dart';
import 'package:afietepatientapp/feature/chat/domain/usecases/send_chat_message_usecase.dart';
import 'package:afietepatientapp/feature/doctors/data/datasources/doctors_remote_datasource.dart';
import 'package:afietepatientapp/feature/doctors/data/repositories/doctors_repository_impl.dart';
...
import 'package:afietepatientapp/feature/feeling/data/repositories/feeling_repository_impl.dart';
...
import 'package:afietepatientapp/feature/feeling/presentation/cubit/feeling_cubit.dart';
import 'package:afietepatientapp/feature/relax/data/datasources/music_local_data_source.dart';
import 'package:afietepatientapp/feature/relax/data/repositories/music_repository_impl.dart';
import 'package:afietepatientapp/feature/relax/domain/repositories/music_repository.dart';
...
import 'package:afietepatientapp/feature/payment/data/datasources/payment_mock_datasource.dart';
import 'package:afietepatientapp/feature/payment/data/datasources/payment_remote_datasource.dart';
import 'package:afietepatientapp/feature/payment/data/repositories/payment_repository_impl.dart';
...
import 'package:afietepatientapp/feature/sessions/data/datasources/sessions_mock_datasource.dart';
import 'package:afietepatientapp/feature/sessions/data/datasources/sessions_remote_datasource.dart';
import 'package:afietepatientapp/feature/sessions/data/repositories/sessions_repository_impl.dart';
...
import 'package:afietepatientapp/feature/settings/data/data_source/settings_mock_data_source.dart';
import 'package:afietepatientapp/feature/settings/data/repositories/settings_repository_impl.dart';
...
import 'package:afietepatientapp/feature/video/data/datasources/video_mock_datasource.dart';
import 'package:afietepatientapp/feature/video/data/datasources/video_remote_datasource.dart';
import 'package:afietepatientapp/feature/video/data/repositories/video_repository_impl.dart';
import 'package:afietepatientapp/feature/video/domain/repositories/video_repository.dart';
import 'package:afietepatientapp/feature/video/domain/usecase/end_video_call_usecase.dart';
import 'package:afietepatientapp/feature/video/domain/usecase/get_video_calls_usecase.dart';
import 'package:afietepatientapp/feature/video/domain/usecase/start_video_call_usecase.dart';
import 'package:afietepatientapp/feature/voice/data/datasources/voice_mock_datasource.dart';
import 'package:afietepatientapp/feature/voice/data/datasources/voice_remote_datasource.dart';
import 'package:afietepatientapp/feature/voice/data/repositories/voice_repository_impl.dart';
import 'package:afietepatientapp/feature/voice/domain/repositories/voice_repository.dart';
import 'package:afietepatientapp/feature/voice/domain/usecase/end_voice_call_usecase.dart';
import 'package:afietepatientapp/feature/voice/domain/usecase/get_voice_calls_usecase.dart';
import 'package:afietepatientapp/feature/voice/domain/usecase/start_voice_call_usecase.dart';
import 'package:afietepatientapp/feature/report/data/datasources/report_remote_datasource.dart';
import 'package:afietepatientapp/feature/report/data/repositories/report_repository_impl.dart';
...
import 'package:afietepatientapp/feature/articles/data/repositories/articles_repository_impl.dart';
...
import 'package:afietepatientapp/feature/auth/data/repositories/auth_repository_impl.dart';
import 'package:afietepatientapp/feature/auth/domain/repositories/auth_repository.dart';
import 'package:afietepatientapp/feature/auth/domain/usecase/login_usecase.dart';
import 'package:afietepatientapp/feature/auth/domain/usecase/signup_usecase.dart';
