// lib/feature/music_and_breathing/data/datasources/relax_mock_data_source.dart
import 'dart:async';
...
import 'relax_remote_data_source.dart';

/// ✅ Mock Data Source للتجربة بدون Backend
/// غيّرها لـ RelaxRemoteDataSourceImpl في injection_container.dart لما يجهز الـ Backend
class RelaxMockDataSource implements RelaxRemoteDataSource {
  FeelingType? _lastSelectedFeeling;

  @override
  Future<FeelingType> getLastSelectedFeeling() async {
    await Future.delayed(const Duration(milliseconds: 300));
    if (_lastSelectedFeeling == null) {
      throw Exception('No feeling saved');
    }
    return _lastSelectedFeeling!;
  }

  @override
  Future<FeelingType> saveLastSelectedFeeling(FeelingType feeling) async {
    await Future.delayed(const Duration(milliseconds: 200));
    _lastSelectedFeeling = feeling;
    return feeling;
  }
  ...
  Future<List<MusicModel>> getRecommendedTracks(
    ...
    final allTracks = _mockMusicTracks;
    final filtered = allTracks
        .where((t) => t.supportedFeelings.contains(params.feeling))
        .toList();

    // خلط التراكات لإعطاء تجربة مختلفة في كل مرة
    filtered.shuffle();
  ...
  Future<List<BreathingExerciseModel>> getBreathingExercises() async {
    ...
    return _mockBreathingExercises;
  }

  // ==========================================
  // ✅ Mock Data - 8 تراكات موسيقى
  // ==========================================
  static final List<MusicModel> _mockMusicTracks = [
    const MusicModel(
      id: 'music_01',
  ...
  // ==========================================
  // ✅ Mock Data - 5 تمارين تنفس
  // ==========================================
  static final List<BreathingExerciseModel> _mockBreathingExercises = [
