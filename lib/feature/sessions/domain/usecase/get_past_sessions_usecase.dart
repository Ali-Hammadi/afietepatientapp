...
class GetPastSessionsUseCase implements UseCase<List<SessionEntity>, NoParams> {
  final SessionsRepository repository;

  const GetPastSessionsUseCase(this.repository);

  @override
  Future<Either<Failure, List<SessionEntity>>> call(NoParams params) {
    return repository.getPastSessions();
  }
}
