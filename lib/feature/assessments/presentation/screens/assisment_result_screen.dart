...
import 'package:afiete/feature/assessments/presentation/widgets/assisment_result_summary_card.dart';
import 'package:afiete/feature/doctors/presentation/widgets/doctor_card.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class AssessmentsResultScreen extends StatelessWidget {
  final AssessmentsResultLoaded state;

  const AssessmentsResultScreen({super.key, required this.state});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomAssessmentsResultSummaryCard(result: state.result),
          const SizedBox(height: 14),
          Text(
          ...
          Center(
            child: TextButton(
              onPressed: () =>
                  context.read<AssessmentsCubit>().retakeAssessments(),
