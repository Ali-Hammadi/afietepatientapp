...
class AssismentLastScoresScreen extends StatelessWidget {
  final List<AssessmentScoreEntry> scores;

  const AssismentLastScoresScreen({super.key, required this.scores});
  ...
  String _severityLabel(String severity) {
    ...
    if (s.contains('minimal') || s.isEmpty) return SettingsStrings.severityMinimal;
    return severity;
  }
      ...
      child: Column(
        ...
        children: [
          ...
          CustomButton(
            ...
            onPressed: () =>
                context.read<AssismentsCubit>().loadQuestions(),
          ),
        ],
      ),
    );
